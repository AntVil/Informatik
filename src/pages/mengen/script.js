...
function beispiel_vereinigung(){
    ...
    circle(ctxt, can.width/4, can.height/4, can.width/15, "#CCCCCC", "#DDDDDD");
    circle(ctxt, can.width/2, can.height/4, can.width/15, "#FFCC00", "#FFFFAA");
    circle(ctxt, can.width*3/4, can.height/4, can.width/15, "#FFCC00", "#FFFFAA");
    circle(ctxt, can.width/4, can.height/2, can.width/15, "#FFCC00", "#FFFFAA");
    circle(ctxt, can.width/2, can.height/2, can.width/15, "#FFCC00", "#FFFFAA");
    circle(ctxt, can.width*3/4, can.height/2, can.width/15, "#FFCC00", "#FFFFAA");
    circle(ctxt, can.width/4, can.height*3/4, can.width/15, "#FFCC00", "#FFFFAA");
    circle(ctxt, can.width/2, can.height*3/4, can.width/15, "#FFCC00", "#FFFFAA");
    circle(ctxt, can.width*3/4, can.height*3/4, can.width/15, "#CCCCCC", "#DDDDDD");
...
function beispiel_schnitt(){
    ...
    circle(ctxt, can.width/4, can.height/4, can.width/15, "#CCCCCC", "#DDDDDD");
    circle(ctxt, can.width/2, can.height/4, can.width/15, "#CCCCCC", "#DDDDDD");
    circle(ctxt, can.width*3/4, can.height/4, can.width/15, "#CCCCCC", "#DDDDDD");
    circle(ctxt, can.width/4, can.height/2, can.width/15, "#CCCCCC", "#DDDDDD");
    circle(ctxt, can.width/2, can.height/2, can.width/15, "#CC00FF", "#FFAAFF");
    circle(ctxt, can.width*3/4, can.height/2, can.width/15, "#CCCCCC", "#DDDDDD");
    circle(ctxt, can.width/4, can.height*3/4, can.width/15, "#CCCCCC", "#DDDDDD");
    circle(ctxt, can.width/2, can.height*3/4, can.width/15, "#CCCCCC", "#DDDDDD");
    circle(ctxt, can.width*3/4, can.height*3/4, can.width/15, "#CCCCCC", "#DDDDDD");
    text(ctxt, "a", can.width/4, can.height/4, can.width/15);
    text(ctxt, "b", can.width/2, can.height/4, can.width/15);
    text(ctxt, "c", can.width*3/4, can.height/4, can.width/15);
...
function beispiel_differenz(){
    ...
    ctxt.clearRect(0, 0, can.width, can.height);
    rect(ctxt, can.width/7, can.height/7, can.width*5/7, can.height*5/7, "#AAAAAAFF", "#00000000", 1, can.width/10);
    rect(ctxt, can.width/7, can.height*2.5/7, can.width*3.5/7, can.height*3.5/7, "#AAFF00", "#00000000", 1, can.width/10);
    rect(ctxt, can.width*2.5/7, can.height/7, can.width*3.5/7, can.height*3.5/7, "#999999FF", "#00000000", 1, can.width/10);
    ...
    circle(ctxt, can.width/2, can.height/4, can.width/15, "#CCCCCC", "#DDDDDD");
    circle(ctxt, can.width*3/4, can.height/4, can.width/15, "#CCCCCC", "#DDDDDD");
    circle(ctxt, can.width/4, can.height/2, can.width/15, "#CCFF00", "#FFFFAA");
    circle(ctxt, can.width/2, can.height/2, can.width/15, "#CCCCCC", "#DDDDDD");
    circle(ctxt, can.width*3/4, can.height/2, can.width/15, "#CCCCCC", "#DDDDDD");
    circle(ctxt, can.width/4, can.height*3/4, can.width/15, "#CCFF00", "#FFFFAA");
    circle(ctxt, can.width/2, can.height*3/4, can.width/15, "#CCFF00", "#FFFFAA");
    circle(ctxt, can.width*3/4, can.height*3/4, can.width/15, "#CCCCCC", "#DDDDDD");
    text(ctxt, "a", can.width/4, can.height/4, can.width/15);
    text(ctxt, "b", can.width/2, can.height/4, can.width/15);
    text(ctxt, "c", can.width*3/4, can.height/4, can.width/15);
...
function beispiel_komplement(){
    ...
    ctxt = can.getContext("2d");
    ctxt.clearRect(0, 0, can.width, can.height);
    rect(ctxt, can.width/7, can.height/7, can.width*5/7, can.height*5/7, "#FF00AA", "#00000000", 1, can.width/10);
    rect(ctxt, can.width/7, can.height*2.5/7, can.width*3.5/7, can.height*3.5/7, "#999999FF", "#00000000", 1, can.width/10);
    rect(ctxt, can.width*2.5/7, can.height*2.5/7, can.width*2/7, can.height*2/7, "#888888FF", "#00000000", 1, can.width/10);
    rect(ctxt, can.width*2.5/7, can.height*2.5/7, can.width*1/7, can.height*1/7, "#888888FF", "#00000000");
    rect(ctxt, can.width*3.5/7, can.height*3.5/7, can.width*1/7, can.height*1/7, "#888888FF", "#00000000");
    rect(ctxt, can.width*2.5/7, can.height/7, can.width*3.5/7, can.height*3.5/7, "#00000011", "#00000000", 1, can.width/10);
    circle(ctxt, can.width/4, can.height/4, can.width/15, "#FF00CC", "#FFAAAA");
    circle(ctxt, can.width/2, can.height/4, can.width/15, "#FF00CC", "#FFAAAA");
    circle(ctxt, can.width*3/4, can.height/4, can.width/15, "#FF00CC", "#FFAAAA");
    circle(ctxt, can.width/4, can.height/2, can.width/15, "#CCCCCC", "#DDDDDD");
    circle(ctxt, can.width/2, can.height/2, can.width/15, "#CCCCCC", "#DDDDDD");
    circle(ctxt, can.width*3/4, can.height/2, can.width/15, "#FF00CC", "#FFAAAA");
    circle(ctxt, can.width/4, can.height*3/4, can.width/15, "#CCCCCC", "#DDDDDD");
    circle(ctxt, can.width/2, can.height*3/4, can.width/15, "#CCCCCC", "#DDDDDD");
    circle(ctxt, can.width*3/4, can.height*3/4, can.width/15, "#FF00CC", "#FFAAAA");
    text(ctxt, "a", can.width/4, can.height/4, can.width/15);
    text(ctxt, "b", can.width/2, can.height/4, can.width/15);
    text(ctxt, "c", can.width*3/4, can.height/4, can.width/15);
    text(ctxt, "d", can.width/4, can.height/2, can.width/15);
